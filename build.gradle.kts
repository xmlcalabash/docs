...
tasks.register("copyStaticFiles") {
  ...
  doFirst {
    copy {
      ...
      into(layout.buildDirectory.dir("docs/css"))
    }
  }
  doFirst {
    copy {
      from(layout.projectDirectory.dir("src/main/js"))
      into(layout.buildDirectory.dir("docs/js"))
    }
  }
  doFirst {
    copy {
      from(layout.projectDirectory.dir("src/main/img"))
      into(layout.buildDirectory.dir("docs/img"))
    }
  }
  doFirst {
    copy {
      from(layout.projectDirectory.dir("src/main/fonts"))
      into(layout.buildDirectory.dir("docs/fonts"))
    }
  }
}
